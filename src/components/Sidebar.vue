<template>
     <div v-if="sesionActiva.value"  class="bg-base-100 w-14 h-[calc(100vh-66px)] fixed top-[66px] z-10 left-0">
...
const rutas = ref([
    ...
    {titulo: 'Open comissions', url: '/open-comission/hojas', icono: IconCashBanknoteFilled},
